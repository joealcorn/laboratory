...
@Experiment.decorator(candidate=dummy_candidate_mismatch, raise_on_mismatch=True)
...
@Experiment.decorator(candidate=dummy_candidate_match, raise_on_mismatch=True)
