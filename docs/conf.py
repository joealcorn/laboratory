# -*- coding: utf-8 -*-
#
# Laboratory documentation build configuration file, created by
...
project = u'Laboratory'
copyright = u'2018, Joe Alcorn'
author = u'Joe Alcorn'
...
release = laboratory.__version__
...
latex_documents = [
    (master_doc, 'Laboratory.tex', u'Laboratory Documentation',
     u'Joe Alcorn', 'manual'),
]
...
man_pages = [
    (master_doc, 'laboratory', u'Laboratory Documentation',
     [author], 1)
]
